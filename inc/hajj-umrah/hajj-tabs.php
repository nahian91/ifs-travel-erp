...
/**
 * Render Sub-Navigation Tabs for Hajj & Umrah Module
 */
function ifs_terp_hajj_render_tabs( $active_tab = 'list' ) {
    ...
    <div class="ifs-module-header">
        <h2 class="ifs-module-title">Hajj & Umrah Operations</h2>
            ...
            <div class="ifs-sub-nav-bar" style="display: flex; gap: 8px; margin-bottom: -2px;">
                <a href="<?php echo esc_url( $base_url . '&sub=list' ); ?>" 
                   class="ifs-sub-nav-btn <?php echo ( $active_tab === 'list' ) ? 'active' : ''; ?>">
                    <span class="dashicons dashicons-groups"></span> Pilgrim Bookings
                </a>
                
                <a href="<?php echo esc_url( $base_url . '&sub=add' ); ?>" 
                   class="ifs-sub-nav-btn <?php echo ( $active_tab === 'add' ) ? 'active' : ''; ?>">
                    <span class="dashicons dashicons-plus-alt2"></span> New Pilgrim Booking
                </a>

                <a href="<?php echo esc_url( $base_url . '&sub=packages' ); ?>" 
                   class="ifs-sub-nav-btn <?php echo ( $active_tab === 'packages' ) ? 'active' : ''; ?>">
                    <span class="dashicons dashicons-palmtree"></span> Package Management
                </a>
                ...
                <?php if ( $active_tab === 'view' ) : ?>
                    <a href="#" class="ifs-sub-nav-btn active">
                        <span class="dashicons dashicons-visibility"></span> Pilgrim Details
                    </a>
                <?php endif; ?>
            </div>
        </div>
